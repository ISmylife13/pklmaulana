...
<!-- navbar header -->
<nav class="navbar navbar-expand-lg navbar-dark fixed-top " style="background-color: #04009A;" >
  
<div class="container">
  
    <a class="navbar-brand" href="#"><i class="fa-solid fa-shop-lock"></i>  YOU SHOP</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="produk-makanan.php">Produk Makanan</a>
        </li>
        <li class="nav-item">
