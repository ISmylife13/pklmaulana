...
// edit 
$id = $_GET['ID'];
$ambil = mysqli_query($koneksi, "SELECT * FROM tbl_pakaian WHERE ID = $id");
...
if(isset($_POST['edit'])){
  ...
  if(!empty($lokasifoto)){
    move_uploaded_file($lokasifoto, "../foto-pakaian/$namafoto");

    mysqli_query($koneksi, "UPDATE tbl_pakaian SET NAMA ='$NAMA', DESKRIPSI='$DESKRIPSI', ALAMAT ='$ALAMAT', CONTACT ='$CONTACT', FOTO ='$namafoto' WHERE ID ='$id'");
  }else{

    mysqli_query($koneksi, "UPDATE tbl_pakaian SET NAMA ='$NAMA', DESKRIPSI='$DESKRIPSI', ALAMAT ='$ALAMAT', CONTACT ='$CONTACT'  WHERE ID ='$id'" );
  }
  echo "<script>alert ('Produk Berhasil Diedit');</script>";

  echo "<script>location='produk-pakaian.php';</script>";
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class="mb-3 mx-3 my-3">
    <img src="../foto-pakaian/?php echo $pecah['FOTO'];?>" width="100">
