...
<!-- btn tambah produk -->
<div>
  <a href="tambah-konter.php" class="btn btn-primary my-3 mx-2 ms-5" >Tambah Produk</a>
</div>
<br>
  <!-- searching -->
...
<tbody>
  ...
  <tr>
    ...
    <td>
    <img src="../foto-konter/<?php echo $pecah ['FOTO'];?>" width="200">
   </td>
 


   <td>
     <a href="hapus-konter.php?ID=<?php echo $pecah ['ID'];?>"
     class="btn-danger btn " onclick="return confirm('Anda Yakin Ingin Menghapus Data ?');">Hapus</a>
     <a href="edit-konter.php?ID=<?php echo $pecah ['ID'];?>"
